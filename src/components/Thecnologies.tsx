...
const technologiesTerminal = [
  ...
  { cmd: "prisma status", result: "Banco de dados configurado ✔️" },
  { cmd: "figma open", result: "UI/UX designs prontos 🎨" },
  {
    cmd: "git push origin main",
    result: "Commit enviado para o repositório remoto ✔️",
  },
];
...
const TypingTerminal = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="
          bg-black text-green-400 font-mono p-6 rounded-md 
